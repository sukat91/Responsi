...
<section class="daftarinventaris" id="daftarinventaris">
   ...
   <div class="form-group">
            <h1 class=" alert alert-info font-family: 'Courier New', Courier, monospace; margin-top: 25px; ">Daftar Inventaris Alat Tulis Kantor</h1>
            <br><br>
          ...
          function convert($value)
            {
                ...
                return $hasil;
					...
					$query = mysqli_query($sambungan, "SELECT * FROM inventaris WHERE kategori='Alat Tulis Kantor'");
